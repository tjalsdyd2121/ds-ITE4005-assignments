...
# here, l_k is already bitmasked form. e.g. l_1 = {18,20,5,6} ==> {[1,3],[2,3],[0,2],[1,2]}
...
# frequent pattern 에 대해서, confidence 구하기.
#def find_confidence():
...
l_k = l_1
# 결국 association rule 찾는거니까 l_1은 필요 없음.
#freq_pat.append(l_k)
...
# With frequent patterns, association rule 찾기.